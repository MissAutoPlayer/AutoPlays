    ...
    public static class SpellManager
    {
        static SpellManager()
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine(
                    DateTime.Now.ToString("[H:mm:ss - ") + "Buddy Error] Exception occurred on initialization of Genesis SpellManager."
                    + Environment.NewLine);
                Console.ResetColor();
                Console.Write(ex);
            }
        ...
        public static void Initialize()
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine(
                    DateTime.Now.ToString("[H:mm:ss - ") + "Buddy Error] Exception occurred on PrepareSpells of Genesis SpellManager."
                    + Environment.NewLine);
                Console.ResetColor();
                Console.Write(ex);
            }
